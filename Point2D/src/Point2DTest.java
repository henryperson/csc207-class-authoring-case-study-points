...
public class Point2DTest {
  ...
  public void testDistance() {
	  ...
	  assertEquals("p1.distance = 5", 5, p1.distance(0, 0));
  ...
  public void testToString() {
	  ...
	  assertEquals("p1.toString = (3, 4)", "\"(3, 4)\"", p1.toString());
	  assertEquals("p2.toString = (1, 1)", "\"(1, 1)\"", p2.toString());
	  assertEquals("p3.toString = (100, 100)", "\"(100, 100)\"", p3.toString());
